...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.0.0/")
  ...
  CONFIG["rubyarchhdrdir"] = "$(DESTDIR)/usr/include/ruby-2.0.0"
  CONFIG["vendorhdrdir"] = "$(DESTDIR)/usr/include/ruby-2.0.0/vendor_ruby"
  CONFIG["sitehdrdir"] = "$(DESTDIR)/usr/local/include/ruby-2.0.0"
  CONFIG["rubyhdrdir"] = "$(DESTDIR)/usr/include/ruby-2.0.0"
  CONFIG["UNIVERSAL_INTS"] = ""
  CONFIG["UNIVERSAL_ARCHNAMES"] = ""
  CONFIG["configure_args"] = " '--srcdir=/usr/src/ports/ruby/ruby-2.0.0-p598-1.i686/src/ruby-2.0.0-p598' '--prefix=/usr' '--exec-prefix=/usr' '--bindir=/usr/bin' '--sbindir=/usr/sbin' '--libexecdir=/usr/libexec' '--datadir=/usr/share' '--localstatedir=/var' '--sysconfdir=/etc' '--libdir=/usr/lib' '--datarootdir=/usr/share' '--docdir=/usr/share/doc/ruby' '--htmldir=/usr/share/doc/ruby/html' '-C' '--with-rubylibprefix=/usr/share/ruby/2.0.0' '--with-rubyarchprefix=/usr/lib/ruby/2.0.0' '--with-rubyhdrdir=/usr/include/ruby-2.0.0' '--with-rubyarchhdrdir=/usr/include/ruby-2.0.0' '--with-sitedir=/usr/local/share/ruby/site_ruby' '--with-sitearchdir=/usr/local/lib/ruby/site_ruby/2.0.0' '--with-sitehdrdir=/usr/local/include/ruby-2.0.0' '--with-vendordir=/usr/share/ruby/vendor_ruby' '--with-vendorarchdir=/usr/lib/ruby/vendor_ruby/2.0.0' '--with-vendorhdrdir=/usr/include/ruby-2.0.0/vendor_ruby' '--with-rubygemsdir=/usr/share/rubygems' '--with-ruby-version=' '--disable-load-relative' '--disable-multiarch' '--enable-shared' 'LDSHARED=gcc -shared' 'DLDFLAGS=-Wl,--export-all-symbols' 'CC=gcc' 'CFLAGS=-ggdb -O2 -pipe -Wimplicit-function-declaration  ' 'LDFLAGS=' 'LIBS=' 'CPPFLAGS=' 'CXX=g++' 'CXXFLAGS=-ggdb -O2 -pipe  '"
  CONFIG["rubygemsdir"] = "$(DESTDIR)/usr/share/rubygems"
  CONFIG["vendorarchdir"] = "$(DESTDIR)/usr/lib/ruby/vendor_ruby/2.0.0"
  CONFIG["vendorlibdir"] = "$(vendordir)"
  CONFIG["vendordir"] = "$(DESTDIR)/usr/share/ruby/vendor_ruby"
  CONFIG["sitearchdir"] = "$(DESTDIR)/usr/local/lib/ruby/site_ruby/2.0.0"
  ...
  CONFIG["rubyarchprefix"] = "$(libdir)/$(RUBY_BASE_NAME)/2.0.0"
  CONFIG["rubylibprefix"] = "$(exec_prefix)/share/$(RUBY_BASE_NAME)/2.0.0"
