...
To create a new profile, click the Add profile button and enter the name of the new profile. Please provide a unique name for your own ease of use.
...
(Dis)Connect: Either connect to a server from a profile of the dropdown menu, or disconnect from the current server.
...
Show messages window: Hide or Show the messages window.
...
Message window:
---------------
The message window shows the output of various operations. If something goes wrong, look for errors here.
